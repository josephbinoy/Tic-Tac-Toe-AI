#the minimax function. It starts the recursive chain, calling minvalue and maxvalue alternatively till leaf node reached.
#why minvalue first? 
...
#function that evaluates given position and returns a score: 1 for X, -1 for O, 0 for draw. 
...
#function that returns the value of the child with lowest utility score
...
#function that returns the value of the child with highest utility score
...
#function that return the player whose turn is next in the given board
def getPlayer(board):
    xCount=0
    oCount=0
    for cell in board:
